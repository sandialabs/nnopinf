...
import sys
import os
sys.path.insert(0, os.path.abspath('../nnopinf'))
...
autodoc_default_options = {
   'members': True,
   'show-inheritance': False, # Ensure this is True or not explicitly set to False
}
...
html_theme_options = {
    ...
    "show_prev_next": False,         # Disable next and previous links
...
html_logo = "_static/nnopinf-logo.png"
